...
cd SophiaTX
git checkout <develop OR a more current branch>
...
If you want to port some data from Steem main network you can use [Tinman](https://github.com/SophiaTX/tinman), also developed by SophiaTX, to help with taking snapshots of the main network.

#### Custom live testnet

An example of a custom testnet run by Steem community member [@almost-digital](https://SophiaTX.com/@almost-digital). It doesn't have a snapshot of the main network
